...
int d11u; int d12u;
int min_unconstrained;
int d11b1; int d12b1;
int min_boundary_linear;
int d11b0; int d12b0;
int d11b100; int d12b100;
int min_boundary_100;
int common;
int det1; int det2; int det3; int det4;
int x1; int x2;
int v1; int v2;
int d11l0; int d12l0;
int d11l100; int d12l100;
...
for (i=0;i<50;i++){
   ...
   if (sol_unconstrained){ 
        min_unconstrained = 0.5*q1*d11u^2 + c1*d11u + y1[0]*(d11u-d1_av[0]) + y1[1]*(d12u-d1_av[1]) + rho/2*(d11u-d1_av[0])^2 + rho/2*(d12u-d1_av[1])^2;
   ...
   if sol_boundary_linear{ 
        min_boundary_linear = 0.5*q1*d11bl^2 + c1*d11bl + y1[0]*(d11bl-d1_av[0]) + y1[1]*(d12bl-d1_av[1]) + rho/2*(d11bl-d1_av[0])^2 + rho/2*(d12bl-d1_av[1])^2;
   ...
   // compute function value and if best store new optimum
   if sol_boundary_0{ 
        min_boundary_0 = 0.5*q1*d11b0^2 + c1*d11b0 + y1[0]*(d11b0-d1_av[0]) + y1[1]*(d12b0-d1_av[1]) + rho/2*(d11b0-d1_av[0])^2 + rho/2*(d12b0-d1_av[1])^2;
   ...
   // compute function value and if best store new optimum
   if (sol_boundary_100){ 
        min_boundary_100 = 0.5*q1*d11b100^2 + c1*d11b100 + y1[0]*(d11b100-d1_av[0]) + y1[1]*(d12b100-d1_av[1]) + rho/2*(d11b100-d1_av[0])^2 + rho/2*(d12b100-d1_av[1])^2;
   ...
   // compute function value and if best store new optimum
   if sol_linear_0{ 
        min_linear_0 = 0.5*q1*d11l0^2 + c1*d11l0 + y1[0]*(d11l0-d1_av[0]) + y1[1]*(d12l0-d1_av[1]) + rho/2*(d11l0-d1_av[0])^2 + rho/2*(d12l0-d1_av[1])^2;
   ...
   // compute function value and if best store new optimum
   if sol_linear_100{ 
        min_linear_100 = 0.5*q1*d11l100^2 + c1*d11l100 + y1[0]*(d11l100-d1_av[0]) + y1[1]*(d12l100-d1_av[1]) + rho/2*(d11l100-d1_av[0])^2 + rho/2*(d12l100-d1_av[1])^2;
